	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (!worldIn.isRemote) {
			...
			if (tile.hasCapability(TeslaCapabilities.CAPABILITY_HOLDER, side)) {
				...
				TextUtils.sendSpamlessMessage(MESSAGE_ID, new TextComponentString(I18n.format("tooltip.teslatest.battery.normal", holder.getStoredPower(), holder.getCapacity())));
			}
		}
