...
/**
 * An interface used by objects that can handle Dank power.
 */
public interface IDankHandler {
    
    /**
     * Gets the amount of dank power stored by the handler.
     * 
     * @param side The side being checked.
     * @return The amount of dank power stored by the handler.
     */
    long getStoredPower (EnumFacing side);
    
    /**
     * Gets the maximum amount of dank power that the handler can hold.
     * 
     * @param side The side being checked.
     * @return The maximum amount of dank power that can be held by the handler.
     */
